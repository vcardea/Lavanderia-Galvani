...
--
-- Host: 127.0.0.1
-- Creato il: Dic 25, 2025 alle 00:42
...
--
INSERT INTO
  `macchine` (`idmacchina`, `nome`, `tipo`, `stato`, `ritardo`)
VALUES
...
--
ALTER TABLE `configurazioni` ADD PRIMARY KEY (`chiave`);

--
-- Indici per le tabelle `macchine`
--
ALTER TABLE `macchine` ADD PRIMARY KEY (`idmacchina`);

--
-- Indici per le tabelle `prenotazioni`
--
ALTER TABLE `prenotazioni` ADD PRIMARY KEY (`idprenotazione`),
...
--
ALTER TABLE `utenti` ADD PRIMARY KEY (`idutente`),
...
--
ALTER TABLE `macchine` MODIFY `idmacchina` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 4;

--
-- AUTO_INCREMENT per la tabella `prenotazioni`
--
ALTER TABLE `prenotazioni` MODIFY `idprenotazione` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 1;

--
-- AUTO_INCREMENT per la tabella `utenti`
--
ALTER TABLE `utenti` MODIFY `idutente` int (11) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 10;
...
--
ALTER TABLE `prenotazioni` ADD CONSTRAINT `prenotazioni_ibfk_1` FOREIGN KEY (`idutente`) REFERENCES `utenti` (`idutente`) ON DELETE CASCADE,
